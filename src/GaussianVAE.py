...
if __name__ == "__main__":
    ...
    parser.add_argument("--no-trains", type=int, default=10, metavar="N",
                        help="Number of training you want to runs, default is %(default)")
    ...
    parser.add_argument("--k", type=int, default=10,
                        help="Number of Gaussian distributions for MoG, if chosen prior = MoG")
    ...
    if args.mode == 'train':
        ...
        with torch.no_grad():
            ...
            plot_latent_with_labels(model, mnist_test_loader, args.device, max_batches=32,
                                    filename="latent_contour_2_another.png")